...
SELECT name,SUM(english),SUM(maths) ,SUM(social)  FROM studentsview GROUP BY name;

SELECT name,SUM(english),SUM(maths) ,SUM(social)  FROM studentsview WHERE name='A';
